...
def build_rag_prompt(query: str, contexts: list, language: str = "auto") -> str:
    ...
    prompt = f"""You are a helpful AI assistant that provides accurate and comprehensive answers based on provided context.

INSTRUCTIONS:
• Use the provided context as your primary source of information
• Provide detailed, helpful answers that fully address the user's question
• {lang_instruction}
• When referencing information, cite sources using [number] format
• Be comprehensive and informative
• If sources provide different perspectives, present them all
• Draw reasonable conclusions and provide practical guidance when appropriate
