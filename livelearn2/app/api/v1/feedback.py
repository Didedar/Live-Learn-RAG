...
async def submit_feedback(
    ...
    try:
        ...
        # Get user IP for spam detection
        user_ip = request.client.host if request.client else "127.0.0.1"
        
        # Process feedback through enhanced handler
        result = await feedback_handler.process_feedback(db, feedback_request, user_ip=user_ip)
